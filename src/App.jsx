...
export default function App() {
  ...
  // Переключение колесиком убрано полностью — на обычной мыши всё равно
  // потребовало бы Shift, а без этого рискует перехватывать обычную
  // прокрутку страницы. Переключение доступно стрелками и точками.
