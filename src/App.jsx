...
const BUSINESS_CATEGORY_OPTIONS_BY_LANG = {
  ...
  zh: ["咖啡店", "餐厅", "咖啡馆", "面包店", "酒吧", "披萨店", "美发沙龙", "理发店", "美甲店", "水疗中心", "按摩师", "健身房", "瑜伽馆", "牙医", "医生", "药店", "兽医", "汽车修理店", "洗车店", "花店", "宠物店", "书店", "服装店", "珠宝店", "家具店", "五金店", "律师事务所", "会计事务所", "房地产中介", "保险代理", "摄影工作室", "纹身店", "干洗店", "锁匠", "电商店铺", "SaaS公司", "营销机构", "自由顾问"],
  ja: ["コーヒーショップ", "レストラン", "カフェ", "パン屋", "バー", "ピザ店", "美容室", "理容室", "ネイルサロン", "スパ", "マッサージ師", "ジム", "ヨガスタジオ", "歯科医", "医師", "薬局", "獣医", "自動車修理店", "洗車場", "花屋", "ペットショップ", "書店", "衣料品店", "宝石店", "家具店", "金物店", "法律事務所", "会計事務所", "不動産会社", "保険代理店", "写真スタジオ", "タトゥーショップ", "クリーニング店", "鍵屋", "ネットショップ", "SaaS企業", "マーケティング会社", "フリーランスコンサルタント"],
  ko: ["커피숍", "레스토랑", "카페", "베이커리", "바", "피자 레스토랑", "헤어살롱", "이발소", "네일샵", "스파", "마사지사", "헬스장", "요가 스튜디오", "치과의사", "의사", "약국", "수의사", "자동차 정비소", "세차장", "꽃집", "펫샵", "서점", "의류 매장", "보석상", "가구점", "철물점", "법률 사무소", "회계 사무소", "부동산 중개소", "보험 대리점", "사진 스튜디오", "문신샵", "세탁소", "열쇠 수리점", "온라인 쇼핑몰", "SaaS 기업", "마케팅 대행사", "프리랜서 컨설턴트"],
  ...
  th: ["ร้านกาแฟ", "ร้านอาหาร", "คาเฟ่", "ร้านเบเกอรี่", "บาร์", "ร้านพิซซ่า", "ร้านทำผม", "ร้านตัดผมชาย", "ร้านทำเล็บ", "สปา", "นักนวด", "ฟิตเนส", "สตูดิโอโยคะ", "ทันตแพทย์", "แพทย์", "ร้านขายยา", "สัตวแพทย์", "อู่ซ่อมรถ", "ร้านล้างรถ", "ร้านดอกไม้", "ร้านขายสัตว์เลี้ยง", "ร้านหนังสือ", "ร้านเสื้อผ้า", "ร้านเครื่องประดับ", "ร้านเฟอร์นิเจอร์", "ร้านฮาร์ดแวร์", "สำนักงานกฎหมาย", "สำนักงานบัญชี", "บริษัทอสังหาริมทรัพย์", "ตัวแทนประกันภัย", "สตูดิโอถ่ายภาพ", "ร้านสัก", "ร้านซักแห้ง", "ร้านทำกุญแจ", "ร้านค้าออนไลน์", "บริษัท SaaS", "เอเจนซี่การตลาด", "ที่ปรึกษาอิสระ"],
  id: ["Kedai kopi", "Restoran", "Kafe", "Toko roti", "Bar", "Restoran pizza", "Salon rambut", "Barbershop", "Salon kuku", "Spa", "Terapis pijat", "Gym", "Studio yoga", "Dokter gigi", "Dokter", "Apotek", "Dokter hewan", "Bengkel mobil", "Cuci mobil", "Toko bunga", "Toko hewan peliharaan", "Toko buku", "Toko pakaian", "Toko perhiasan", "Toko furnitur", "Toko perkakas", "Firma hukum", "Firma akuntansi", "Agen properti", "Agen asuransi", "Studio foto", "Studio tato", "Dry cleaner", "Tukang kunci", "Toko online", "Perusahaan SaaS", "Agensi pemasaran", "Konsultan lepas"],
  el: ["Καφετέρια", "Εστιατόριο", "Καφέ", "Αρτοποιείο", "Μπαρ", "Πιτσαρία", "Κομμωτήριο", "Κουρείο", "Σαλόνι νυχιών", "Σπα", "Μασέρ", "Γυμναστήριο", "Στούντιο γιόγκα", "Οδοντίατρος", "Γιατρός", "Φαρμακείο", "Κτηνίατρος", "Συνεργείο αυτοκινήτων", "Πλυντήριο αυτοκινήτων", "Ανθοπωλείο", "Κατάστημα κατοικίδιων", "Βιβλιοπωλείο", "Κατάστημα ρούχων", "Κοσμηματοπωλείο", "Κατάστημα επίπλων", "Κατάστημα εργαλείων", "Δικηγορικό γραφείο", "Λογιστικό γραφείο", "Μεσιτικό γραφείο", "Ασφαλιστικός πράκτορας", "Φωτογραφικό στούντιο", "Κατάστημα τατουάζ", "Στεγνοκαθαριστήριο", "Κλειδαράς", "Ηλεκτρονικό κατάστημα", "Εταιρεία SaaS", "Διαφημιστική εταιρεία", "Ανεξάρτητος σύμβουλος"],
